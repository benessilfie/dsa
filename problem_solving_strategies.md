# Notes: Algorithms and Problem Solving Patterns : Introduction to Problem Solving Part 2
...
This pattern involves creating pointers or values that correspond to an index or position and move towards the beginning, end or middle based on a certain condition.

It is also very efficient for solving problems with minimal space complexity.
